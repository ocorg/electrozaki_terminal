...
export default function AttendanceWidget({ storeId }: AttendanceWidgetProps) {
  ...
  const nextAction    = isCurrentlyIn ? 'sortie' : 'entree'
    ...
    <div className="bg-white border border-[#E8E5DE] rounded-2xl p-5"
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          style={{
            backgroundColor: nextAction === 'entree' ? `${primary}15` : '#FEF2F2',
            color:           nextAction === 'entree' ? primary : '#EF4444',
            border:          `1px solid ${nextAction === 'entree' ? `${primary}30` : '#FECACA'}`,
          }}
        >
          {punching
