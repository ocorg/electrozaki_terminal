...
function getNavItems(portalBase: string, portalType: string): NavItem[] {
  ...
  return [
    ...
    { href: `${portalBase}/prospects`,        icon: ClipboardList,   label: 'Prospects',          roles: ['gerant','proprietaire'] },
    ...
    { divider: true, label: 'SITE WEB',                                                           roles: ['gerant','proprietaire'] },
    { href: `${portalBase}/site/orders`,      icon: ShoppingBag,     label: 'Commandes web',      roles: ['gerant','proprietaire'], badge: 'orders' },
    { href: `${portalBase}/site/requests`,    icon: Inbox,           label: 'Demandes du site',   roles: ['gerant','proprietaire'], badge: 'repairs' },
