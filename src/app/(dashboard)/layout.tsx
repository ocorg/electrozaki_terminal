...
// 1. We add the missing import here
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    /* 2. We wrap everything in the 'ez' (Electro Zaki) portal type */
    <PortalProvider type="ez">
      <div className="flex h-screen bg-ez-bg overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          {/* Page Content */}
          <main className="flex-1 overflow-x-hidden overflow-y-auto bg-ez-bg">
            {children}
          </main>
        </div>
      </div>
